...
if (currentPage.includes("homepage.jsp")) {
    setActive(homeLink);
} else if (currentPage.includes("favorite.jsp")) {
    setActive(favoriteLink);
} else if (currentPage.includes("pastProject.jsp")) {
  setActive(pastProjectLink);
} else if (currentPage.includes("progLanguage.jsp")) {
  setActive(progLanguageLink);
} else if (currentPage.includes("knowledge.jsp")) {
  setActive(knowledgeLink);
} else if (currentPage.includes("feedback.jsp")) {
  setActive(feedbackLink);
} else {
    setActive(moreLink);
}